...
TEST(SubstitutionFormatterTest, DownstreamPeerCertVStartFormatter) {
  ...
  // No downstreamSslConnection
  {
    ...
    EXPECT_EQ("-", cert_start_format.format(request_headers, response_headers, response_trailers,
                                            stream_info, body));
...
TEST(SubstitutionFormatterTest, DownstreamPeerCertVEndFormatter) {
  ...
  // No downstreamSslConnection
  {
    ...
    EXPECT_EQ("-", cert_end_format.format(request_headers, response_headers, response_trailers,
                                          stream_info, body));
